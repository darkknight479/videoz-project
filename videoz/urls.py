...
urlpatterns = [
    ...
    #Auth
    path('signup',views.SignUp.as_view(template_name='halls/registration/signup.html'),name='signup'),
    path('login',auth_views.LoginView.as_view(template_name='halls/registration/login.html'),name='login'),
